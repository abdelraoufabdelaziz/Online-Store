...
<html lang="en">
    ...
    <body>
	 ...
	 <li class=""><a href="product_history.jsp">History</a></li>
                    ...
                    <div class="span9">
                        ...
                        <div class="row">
                            ...
                            <div id="gallery" class="span3">
                                <a href="themes/mobile_images/xiaomi.jpg" >
                                    <img src="themes/mobile_images/xiaomi.jpg" style="width:100%" />

                                </a>
                            </div>
                            <div class="span6">
                                <h3>  <%
                                    PreparedStatement stmt62 = con.prepareStatement("select * from mobile_product where id_product=5");
                                ...
                                <div class="control-group">
                                    <label class="control-label"><span>  <%
                                        PreparedStatement stmt2 = con.prepareStatement("select * from mobile_product where id_product=5 ");
                                        ResultSet rs2 = stmt2.executeQuery();
                                        out.println("<table>");
                                        while (rs2.next()) {
                                    ...
                                    <div class="controls">
                                        ...
                                        <form action="AddCartMobile" method="get"><input type="hidden" name="id_product" value="5"/><button type="submit">Add to <i class="icon-shopping-cart"></i></button> </form> 
                                    </div>                          <%
                                        }
                                    %>
                                ...
                                <hr class="soft"/>
                                <h4>  <%
                                    PreparedStatement stmt6 = con.prepareStatement("select * from mobile_product where id_product=5");
                                ...
                                <p>
                                    <%
                                        PreparedStatement stmt4 = con.prepareStatement("select * from mobile_product where id_product=5 ");
                                    ...
                                    <div class="tab-pane fade active in" id="home">
                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                                ...
                                                <tr class="techSpecRow"><td class="techSpecTD1">Brand: </td><td class="techSpecTD2">Xiaomi</td></tr>
                                                <tr class="techSpecRow"><td class="techSpecTD1">Description:</td><td class="techSpecTD2">Xiaomi Poco X3 NFC Dual Sim Smartphone 6.67 Inch- 6GB Ram- 64GB</td></tr>

                                                <tr class="techSpecRow"><td class="techSpecTD1">Battery Capacity in mAh:</td><td class="techSpecTD2"> 5000 - 6000 milliampere_hour</td></tr>
                                                <tr class="techSpecRow"><td class="techSpecTD1">Display size:</td><td class="techSpecTD2"> 6.67 inches</td></tr>
                                                <tr class="techSpecRow"><td class="techSpecTD1">Rear Camera Resolution:</td><td class="techSpecTD2">64 megapixels</td></tr>
        ...
        <div>
            <a href="themes/mobile_images/xia1.jpg" >
                <img src="themes/mobile_images/xia1.jpg" style="width:30%" />
            </a>
            <a href="themes/mobile_images/xia2.jpg" >
                <img src="themes/mobile_images/xia2.jpg" style="width:30%" />
            </a>
        </div>
    </div>

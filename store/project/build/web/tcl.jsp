...
<html lang="en">
    ...
    <body>
                        ...
                        <%                session = request.getSession(false);
                            ...
                            if (name_user == null) {
                                ...
                                try {
                                    ...
                                    result60 = stmt60.executeQuery("select SUM(quantity) from cart where id_user='" + email_user + "'");
	 ...
	 <li class=""><a href="product_history.jsp">History</a></li>
                    ...
                    <div class="span9">
                        ...
                        <div class="row">
                            ...
                            <div id="gallery" class="span3">
                                <a href="themes/mobile_images/tcl.jpg" >
                                    <img src="themes/mobile_images/tcl.jpg" style="width:100%" />

                                </a>
                            </div>
                            <div class="span6">
                                <h3>  <%
                                    PreparedStatement stmt62 = con.prepareStatement("select * from mobile_product where id_product=10");
                                ...
                                <div class="control-group">
                                    <label class="control-label"><span>  <%
                                        PreparedStatement stmt2 = con.prepareStatement("select * from mobile_product where id_product=10 ");
                                        ResultSet rs2 = stmt2.executeQuery();
                                        out.println("<table>");
                                        while (rs2.next()) {
                                    ...
                                    <div class="controls">
                                        ...
                                        <form action="AddCartMobile" method="get"><input type="hidden" name="id_product" value="10"/><button type="submit">Add to <i class="icon-shopping-cart"></i></button> </form> 
                                    </div>                           <%
                                        }
                                    %>
                                ...
                                <hr class="soft"/>
                                <h4>  <%
                                    PreparedStatement stmt6 = con.prepareStatement("select * from mobile_product where id_product=10");
                                ...
                                <p>
                                    <%
                                        PreparedStatement stmt4 = con.prepareStatement("select * from mobile_product where id_product=10 ");
                                    ...
                                    <div class="tab-pane fade active in" id="home">
                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                                ...
                                                <tr class="techSpecRow"><td class="techSpecTD1">Brand: </td><td class="techSpecTD2">TCL</td></tr>
                                                <tr class="techSpecRow"><td class="techSpecTD1">Description:</td><td class="techSpecTD2">TCL 10 Plus Mobile Phone, Dual SIM 6.47 Inch, 256 GB, 6 GB RAM, 4G</td></tr>

                                                <tr class="techSpecRow"><td class="techSpecTD1">Battery Capacity in mAh:</td><td class="techSpecTD2"> 4300mAh</td></tr>
                                                <tr class="techSpecRow"><td class="techSpecTD1">Display size:</td><td class="techSpecTD2"> 6.5 inches</td></tr>
                                                <tr class="techSpecRow"><td class="techSpecTD1">Rear Camera Resolution:</td><td class="techSpecTD2">64 MP + 8 MP + 2 MP</td></tr>
                                                <tr class="techSpecRow"><td class="techSpecTD1">Memory RAM:</td><td class="techSpecTD2"> 4 GB</td></tr>
        ...
        <div>
            <a href="themes/mobile_images/tcl1.jpg" >
                <img src="themes/mobile_images/tcl1.jpg" style="width:30%" />
            </a>
            <a href="themes/mobile_images/tcl2.jpg" >
                <img src="themes/mobile_images/tcl2.jpg" style="width:30%" />
            </a>

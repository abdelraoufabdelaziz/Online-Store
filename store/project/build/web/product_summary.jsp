            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <h3>  SHOPPING CART [ <small><%= total_quantity%> Item(s) </small>]<a href="loginindex.jsp" class="btn btn-large pull-right"><i class="icon-arrow-left"></i> Continue Shopping </a></h3>	
                        <hr class="soft"/>
                        <%
                            ...
                            <tbody>
                                ...
                                <%                Connection c = null;
                                    ...
                                    try {
                                        ...
                                        stmt2 = c.createStatement();
                                        result = stmt60.executeQuery("select mobile_product.id_product,quantity,name_product,price_product,SUM(quantity*price_product),description,img_product from cart,mobile_product where email_user='" + email_user + "' AND cart.id_mobile=mobile_product.id_product GROUP by mobile_product.id_product,cart.quantity");
                                        result2 = stmt2.executeQuery("select laptop.id_product,quantity,name_product,price_product,SUM(quantity*price_product),description_product,img_product from cart,laptop where email_user='" + email_user + "' AND cart.id_laptop=laptop.id_product GROUP by laptop.id_product,cart.quantity");
                                        while (result.next()) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- for mobile -->
                                        <div class="input-append"><form method="get" action="UpdateCart"><input type="hidden" name="p_id" value="<%=p_id%>"/><input class="span1" style="max-width:34px" placeholder="<%=quantity%>" id="appendedInputButtons" size="16" type="text" name="edit_number"/><button type="submit">confirm</button></form> <form method="get" action="RemoveProduct"><input type="hidden" name="p_id" value="<%=p_id%>"/><button type="submit">remove</button></form> </div>
                                    </td>
                                    <td>$ <%= p_price%></td>
                                </tr>
                                <%
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- for laptop -->
                                        <div class="input-append"><form action="UpdateCart2" method="get"><input type="hidden" name="p_id" value="<%=p_id%>"/><input class="span1" style="max-width:34px" placeholder="<%=quantity%>" id="appendedInputButtons" size="16" type="text" name="edit_number"/><button type="submit">confirm</button></form> <form method="get" action="Removeproduct2"><input type="hidden" name="p_id" value="<%=p_id%>"/><button type="submit">remove</button></form>  </div>
                                    </td>
                                    <td>$ <%= p_price%></td>
                                </tr>
                                <%
                                ...
                                <tr>
                                    ...
                                    <td class="label label-important" style="display:block"> <strong> $<%= total_price + total_price2%> </strong></td>
                                </tr>
                            </tbody>
                        </table>
                        <%
                        ...
                        <form action="ApplyCart" method="get">
                            <input type="hidden" name="total_price" value="<%= total_price + total_price2%>"/>
                            <button type="submit" class="btn btn-large pull-right">Buy <i class="icon-arrow-right"></i></button>
                        </form>
                        <%
                            }
                        %>

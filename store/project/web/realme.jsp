...
<%if(name_user==null)
 ...
 <%!
                    ...
                    <div class="span9">
                        ...
                        <div class="row">
                            ...
                            <div id="gallery" class="span3">
                                <a href="themes/mobile_images/realme.jpg" >
                                    <img src="themes/mobile_images/realme.jpg" style="width:100%" />
                                
                                </a>
                            </div>
                            <div class="span6">
                                <h3>  <%
                                    PreparedStatement stmt62 = con.prepareStatement("select * from mobile_product where id_product=6");
                                ...
                                <hr class="soft"/>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label"><span>  <%
                                            PreparedStatement stmt2 = con.prepareStatement("select * from mobile_product where id_product=6 ");
                                            ResultSet rs2 = stmt2.executeQuery();
                                            out.println("<table>");
                                            while (rs2.next()) {
         ...
         <div class="controls">
					  ...
					  <form action="AddCartMobile" method="get"><input type="hidden" name="id_product" value="6"/><button type="submit">Add to <i class="icon-shopping-cart"></i></button> </form> 
                                        </div>                               <%
                                        }
                                    %>
                                ...
                                <hr class="soft"/>
                                <h4>  <%
                                    PreparedStatement stmt6 = con.prepareStatement("select * from mobile_product where id_product=6");
                                ...
                                <p>
                                    <%
                                        PreparedStatement stmt4 = con.prepareStatement("select * from mobile_product where id_product=6 ");
                                    ...
                                    <div class="tab-pane fade active in" id="home">
                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                                ...
                                                <tr class="techSpecRow"><td class="techSpecTD1">Brand: </td><td class="techSpecTD2">Realme</td></tr>
                                                <tr class="techSpecRow"><td class="techSpecTD1">Description:</td><td class="techSpecTD2">Realme 6 Dual SIM - 128GB, 4GB RAM, 4G LTE - Comet</td></tr>
    ...
    <div>
<a href="themes/mobile_images/real1.jpg" >
                                       <img src="themes/mobile_images/real1.jpg" style="width:100%" />
</a>

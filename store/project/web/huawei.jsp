...
<html lang="en">
    ...
    <body>
	 ...
	 <li class=""><a href="product_history.jsp">History</a></li>
                    ...
                    <div class="span9">
                        ...
                        <div class="row">
                            ...
                            <div id="gallery" class="span3">
                                <a href="themes/mobile_images/huawei.jpg" >
                                    <img src="themes/mobile_images/huawei.jpg" style="width:100%" />

                                </a>
                            </div>
                            <div class="span6">
                                <h3>  <%
                                    PreparedStatement stmt62 = con.prepareStatement("select * from mobile_product where id_product=4");
                                ...
                                <div class="control-group">
                                    <label class="control-label"><span>  <%
                                        PreparedStatement stmt2 = con.prepareStatement("select * from mobile_product where id_product=4 ");
                                        ResultSet rs2 = stmt2.executeQuery();
                                        out.println("<table>");
                                        while (rs2.next()) {
                                    ...
                                    <div class="controls">
                                        ...
                                        <form action="AddCartMobile" method="get"><input type="hidden" name="id_product" value="4"/><button type="submit">Add to <i class="icon-shopping-cart"></i></button> </form> 
                                    </div>                                        <%
                                        }
                                    %>
                                ...
                                <p>
                                    <%
                                        PreparedStatement stmt4 = con.prepareStatement("select * from mobile_product where id_product=4 ");
                                    ...
                                    <div class="tab-pane fade active in" id="home">
                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                                ...
                                                <tr class="techSpecRow"><td class="techSpecTD1">Brand: </td><td class="techSpecTD2">Huawei</td></tr>
                                                <tr class="techSpecRow"><td class="techSpecTD1">Description:</td><td class="techSpecTD2">HUAWEI Y8p Dual SIM - 128 GB, 6 GB RAM, 4G LTE - Midnight Black</td></tr>

                                                <tr class="techSpecRow"><td class="techSpecTD1">Battery Capacity in mAh:</td><td class="techSpecTD2"> 4000 - 5000 milliampere_hour</td></tr>
                                                <tr class="techSpecRow"><td class="techSpecTD1">Display size:</td><td class="techSpecTD2"> 6.3 Inch</td></tr>
                                                <tr class="techSpecRow"><td class="techSpecTD1">Rear Camera Resolution:</td><td class="techSpecTD2">48 MP</td></tr>
        ...
        <div>
            <a href="themes/mobile_images/hua1.jpg" >
                <img src="themes/mobile_images/hua1.jpg" style="width:100%" />
            </a>
        </div>
    </div>

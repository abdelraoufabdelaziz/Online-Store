    ...
    <body>
        ...
        <%
            ...
            try {
                ...
                sql = "select name_product,price_product,description_product from product where id_product=?";
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <h4 style="text-align:center"><a class="btn" href="product_details.html"> <i class="icon-zoom-in"></i></a> 
                                    ...
                                    <a href="#login" role="button" data-toggle="modal" style="padding-right:0"><span class="btn">Edit</span></a>
                                    <div id="login" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                            <h3>Edit product</h3>
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal loginFrm" action="EditProduct" method="post">
                                                <div class="control-group">								
                                                    <input type="text"  placeholder="Product name" name="name" value="<% out.println(name); %>" readonly="readonly">
                                                </div>
                                                <div class="control-group">
                                ...
                                </a> <a class="btn btn-primary" href="#" > <% out.println(price + "$"); %></a></h4>
                    </div>
                </div>
            </li>
            ...
            <li class="span3">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <h4 style="text-align:center"><a class="btn" href="product_details.html"> <i class="icon-zoom-in"></i></a> <a class="btn" href="AdminEdit.jsp">Edit <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#"><% out.println(price + "$"); %></a></h4>
                    </div>
                </div>
            </li>
            <li class="span3">

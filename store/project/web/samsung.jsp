...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="span6">Welcome!
                        ...
                        <%                session = request.getSession(false);
                            ...
                            if (name_user == null) {
                                ...
                                ResultSet result60 = null;
                                try {
                                    Class.forName("com.mysql.cj.jdbc.Driver");
                                    c = DriverManager.getConnection(url, user, password);
                                    stmt6 = c.createStatement();
                                    stmt60 = c.createStatement();
                                    result60 = stmt60.executeQuery("select SUM(quantity) from cart where email_user='" + email_user + "'");
                                    result = stmt6.executeQuery("select balance from registration where id=" + iduser);
                                    while (result60.next()) {
                                        total_quantity = result60.getInt(1);
                                    }
                                    while (result.next()) {
	 ...
	 <li class=""><a href="product_history.jsp">History</a></li>
                    ...
                    <div id="sidebar" class="span3">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <%  if (permission != 1) {
                                %>
                                <h4 style="text-align:center"><a class="btn" href="nokia.jsp"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">
                                        <%
                                            }
                                        %>
                                        ...
                                        <%
                                            ...
                                            PreparedStatement stmtt10 = con.prepareStatement("select * from mobile_product where id_product=3");
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <%  if (permission != 1) {
                                %>
                                <h4 style="text-align:center"><a class="btn" href="samsung.jsp"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">
                                        <%
                                            }
                                        %>
                    ...
                    <div class="span9">
                        ...
                        <div class="row">
                            ...
                            <div id="gallery" class="span3">
                                <a href="themes/mobile_images/ssamsung.jpg" >
                                    <img src="themes/mobile_images/ssamsung.jpg" style="width:100%" />

                                </a>
                            </div>
                            <div class="span6">
                                <h3>  <%
                                    PreparedStatement stmt62 = con.prepareStatement("select * from mobile_product where id_product=3");
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <form action="AddCartMobile" method="get"><input type="hidden" name="id_product" value="3"/><button type="submit">Add to <i class="icon-shopping-cart"></i></button></form> 
                                    </div>                              <%
                                        }
                                    %>
                                ...
                                <hr class="soft"/>
                                <h4>  <%
                                    PreparedStatement stmt6 = con.prepareStatement("select * from mobile_product where id_product=3");
                                    ...
                                    <div class="tab-pane fade active in" id="home">
                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                                ...
                                                <tr class="techSpecRow"><td class="techSpecTD1">Brand: </td><td class="techSpecTD2">Samsung</td></tr>
                                                <tr class="techSpecRow"><td class="techSpecTD1">Description:</td><td class="techSpecTD2">Samsung Galaxy M31 Dual SIM - 128GB, 6GB RAM, 4G LTE</td></tr>

                                                <tr class="techSpecRow"><td class="techSpecTD1">Battery Capacity in mAh:</td><td class="techSpecTD2"> 6000 milliampere_hour & above</td></tr>
                                                <tr class="techSpecRow"><td class="techSpecTD1">Display size:</td><td class="techSpecTD2"> 6.4 inches</td></tr>
                                                <tr class="techSpecRow"><td class="techSpecTD1">Rear Camera Resolution:</td><td class="techSpecTD2">64MP + 8MP + 5MP + 5MP</td></tr>
                                                <tr class="techSpecRow"><td class="techSpecTD1">Memory RAM:</td><td class="techSpecTD2"> 6 GB</td></tr>
        ...
        <div>
            <a href="themes/mobile_images/sam1.jpg" >
                <img src="themes/mobile_images/sam1.jpg" style="width:100%" />
            </a>
        </div>
    </div>

...
<html lang="en">
                ...
                <div class="span9">
                    ...
                    <div class="row">
                        ...
                        <div id="gallery" class="span3">
                            <a href="themes/mobile_images/infinix.jpg" >
                                <img src="themes/mobile_images/infinix.jpg" style="width:100%" />

                            </a>
                        </div>
                        <div class="span6">
                            <h3>  <%
                                PreparedStatement stmt62 = con.prepareStatement("select * from mobile_product where id_product=8");
                            ...
                            <div class="control-group">
                                <label class="control-label"><span>  <%
                                    PreparedStatement stmt2 = con.prepareStatement("select * from mobile_product where id_product=8 ");
                                    ResultSet rs2 = stmt2.executeQuery();
                                    out.println("<table>");
                                    while (rs2.next()) {
                                ...
                                <div class="controls">
                                    ...
                                    <form action="AddCartMobile" method="get"><input type="hidden" name="id_product" value="8"/><button type="submit">Add to <i class="icon-shopping-cart"></i></button> </form> 
                                </div>                                      <%
                                    }
                                %>
                            ...
                            <hr class="soft"/>
                            <h4>  <%
                                PreparedStatement stmt6 = con.prepareStatement("select * from mobile_product where id_product=8");
                            ...
                            <p>
                                <%
                                    PreparedStatement stmt4 = con.prepareStatement("select * from mobile_product where id_product=8 ");
                                ...
                                <div class="tab-pane fade active in" id="home">
                                    ...
                                    <table class="table table-bordered">
                                        <tbody>
                                            ...
                                            <tr class="techSpecRow"><td class="techSpecTD1">Brand: </td><td class="techSpecTD2">Infinix</td></tr>
                                            <tr class="techSpecRow"><td class="techSpecTD1">Description:</td><td class="techSpecTD2">Infinix Note 7 Dual SIM Mobile Phone, Quad Rear Cameras, 6.95 Inch Touch Screen, 6 GB RAM, 128 GB Storage, 4G LTE</td></tr>
    ...
    <div>
        <a href="themes/mobile_images/inf1.jpg" >
            <img src="themes/mobile_images/inf1.jpg" style="width:30%" />
        </a>
        <a href="themes/mobile_images/inf2.jpg" >
            <img src="themes/mobile_images/inf2.jpg" style="width:30%" />
        </a>
